...
public class TouchView extends View {
    ...
    private float mLeftTopPosX = 250;
    private float mLeftTopPosY = 400;

    private float mRightTopPosX = 1500;
    private float mRightTopPosY = 400;

    private float mLeftBottomPosX = 250;
    private float mLeftBottomPosY = 580;

    private float mRightBottomPosX = 1500;
    private float mRightBottomPosY = 580;
    private float mPosX;
    private float mPosY;
